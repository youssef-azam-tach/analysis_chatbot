...
try:
    ...
    _st_msg("error", "Ollama not installed. Please install it with: pip install ollama")
...
"""
            ...
            _st_msg("success", "✅ Data context loaded for chatbot")
            return True
        
        except Exception as e:
            _st_msg("error", f"Error generating data context: {str(e)}")
            return False
...
Be concise but thorough in your explanations."""
    ...
    def get_available_models(self) -> List[str]:
        ...
        try:
            ...
            _st_msg("error", f"Error fetching models: {str(e)}")
            return ["qwen2.5:7b"]
